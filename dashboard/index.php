...
if ($_COOKIE["sig"] !== hash("sha256", $row["name"])) {
            ...
            <div class="sidebar-wrapper active shadow-lg">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <a href="logout.php" class="btn btn-danger mt-5 w-100">Logout</a>
                    </ul>
                </div>
            </div>
        </div>
        <div class="card rounded-0 position-fixed top-0 w-100 z-1 shadow-lg">
            <div class="d-flex justify-content-end align-items-center p-3">
                <h2 class="me-3"><?= $row["name"] ?></h2>
                <img src="../assets/static/img/profile.png" alt="Profile" class="rounded-circle"
