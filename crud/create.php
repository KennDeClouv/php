                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control"
                                                                placeholder="Input your name" id="first-name-icon"
                                                                name="nama" required>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control"
                                                                placeholder="Your age" id="first-name-icon" name="umur"
                                                                required>
                                                            <div class="form-control-icon">
                                                                <i class="bi bi-alt"></i>
                                                            </div>
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="date" class="form-control"
                                                                placeholder="birth date" id="first-name-icon"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter Address" id="first-name-icon"
