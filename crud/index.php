...
<body>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub active" id="Form Validation">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="submenu-item">
                                    <a href="./create.php" class="submenu-link">Create</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="card mt-4">
                <div class="card-body fs-5">
                    ...
                    <div>
                        ...
                        // $accout = mysqli_query($con, $query);
                        ?>
                        <h2>Dataa</h2>
                        <div class="d-flex justify-content-between mt-4">
                            <form action="" method="POST">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Input to search"
                                        name="keyword">
                        ...
                        <div class="highlight mt-3">
                            <table class="table">
                                ...
                                <?php foreach ($accout as $acc): ?>
                                    <tr>
                                        <td><?= $acc["id"] ?></td>
                                        <td><?= $acc["nama"] ?></td>
                                        <td><?= $acc["umur"] ?></td>
                                        <td><?= $acc["tanggal_lahir"] ?></td>
                                        <td><?= $acc["alamat"] ?></td>
                                        <td>
                                            <a href="update.php?id=<?= $acc["id"] ?>"><i
                                                    class="bi bi-pen me-2 text-warning"></i></a>
                                            <a href="delete.php?id=<?= $acc["id"] ?>"><i
  ...
  <span class="line"><span class="cl"><span class="nt">//function to display table data
