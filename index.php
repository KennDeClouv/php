...
if (isset($_SESSION["cookie_valid"]) === true) {
...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $row["password"])) {
            ...
            setcookie("sig", hash("sha256", $row["name"]), time() + 86400 * 30, "/");
            header("Location: dashboard");
        } else {
            $error_password = true;
        }
            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <?php if (isset($error_username)): ?>
                        <p class="text-danger fs-5">Username not found</p>
                    <?php endif; ?>
                    <?php if (isset($error_password)): ?>
                        <p class="text-danger fs-5">Password is incorrect</p>
                    <?php endif; ?>
                    ...
                    <p class="text-center mt-3 fs-5">Dont have an account? <a href="register">Register here</a>.</p>
                </div>
            </div>
